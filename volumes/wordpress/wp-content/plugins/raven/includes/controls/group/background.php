...
class Background extends Group_Control_Base {
	...
	private static function init_background_types() {
		return [
			'classic' => [
				'title' => _x( 'Classic', 'Background Control', 'raven' ),
				'icon' => 'fa fa-paint-brush',
			],
			'gradient' => [
				'title' => _x( 'Gradient', 'Background Control', 'raven' ),
				'icon' => 'fa fa-barcode',
			],
			'video' => [
				'title' => _x( 'Background Video', 'Background Control', 'raven' ),
	...
	public function init_fields() {
		...
		$fields['background'] = [
			'label' => _x( 'Background Type', 'Background Control', 'raven' ),
			'type' => 'choose',
			'label_block' => false,
			'render_type' => 'ui',
		];
		...
		$fields['color'] = [
			'label' => _x( 'Color', 'Background Control', 'raven' ),
			'type' => 'color',
			'default' => '',
			'title' => _x( 'Background Color', 'Background Control', 'raven' ),
			'selectors' => [
		...
		$fields['color_stop'] = [
			'label' => _x( 'Location', 'Background Control', 'raven' ),
			'type' => 'slider',
			'size_units' => [ '%' ],
			'default' => [
				'unit' => '%',
		...
		$fields['color_b'] = [
			'label' => _x( 'Second Color', 'Background Control', 'raven' ),
			'type' => 'color',
			'default' => '#f2295b',
			'render_type' => 'ui',
			'condition' => [
		...
		$fields['gradient_type'] = [
			'label' => _x( 'Type', 'Background Control', 'raven' ),
			'type' => 'select',
			'options' => [
				'linear' => _x( 'Linear', 'Background Control', 'raven' ),
				'radial' => _x( 'Radial', 'Background Control', 'raven' ),
			],
			'default' => 'linear',
			'render_type' => 'ui',
			'condition' => [
		...
		$fields['gradient_angle'] = [
			'label' => _x( 'Angle', 'Background Control', 'raven' ),
			'type' => 'slider',
			'size_units' => [ 'deg' ],
			'default' => [
				'unit' => 'deg',
		...
		$fields['gradient_position'] = [
			'label' => _x( 'Position', 'Background Control', 'raven' ),
			'type' => 'select',
			'options' => [
				'center center' => _x( 'Center Center', 'Background Control', 'raven' ),
				'center left' => _x( 'Center Left', 'Background Control', 'raven' ),
				'center right' => _x( 'Center Right', 'Background Control', 'raven' ),
				'top center' => _x( 'Top Center', 'Background Control', 'raven' ),
				'top left' => _x( 'Top Left', 'Background Control', 'raven' ),
				'top right' => _x( 'Top Right', 'Background Control', 'raven' ),
				'bottom center' => _x( 'Bottom Center', 'Background Control', 'raven' ),
				'bottom left' => _x( 'Bottom Left', 'Background Control', 'raven' ),
				'bottom right' => _x( 'Bottom Right', 'Background Control', 'raven' ),
			],
		...
		$fields['image'] = [
			'label' => _x( 'Image', 'Background Control', 'raven' ),
			'type' => 'media',
			'title' => _x( 'Background Image', 'Background Control', 'raven' ),
			'selectors' => [
		...
		$fields['position'] = [
			...
			'default' => '',
			'options' => [
				'' => _x( 'Default', 'Background Control', 'raven' ),
				'top left' => _x( 'Top Left', 'Background Control', 'raven' ),
				'top center' => _x( 'Top Center', 'Background Control', 'raven' ),
				'top right' => _x( 'Top Right', 'Background Control', 'raven' ),
				'center left' => _x( 'Center Left', 'Background Control', 'raven' ),
		...
		$fields['attachment'] = [
			'label' => _x( 'Attachment', 'Background Control', 'raven' ),
			'type' => 'select',
			'default' => '',
			'options' => [
				'' => _x( 'Default', 'Background Control', 'raven' ),
				'scroll' => _x( 'Scroll', 'Background Control', 'raven' ),
				'fixed' => _x( 'Fixed', 'Background Control', 'raven' ),
			],
			'selectors' => [
		...
		$fields['repeat'] = [
			'label' => _x( 'Repeat', 'Background Control', 'raven' ),
			'type' => 'select',
			'default' => '',
			'options' => [
				'' => _x( 'Default', 'Background Control', 'raven' ),
				'no-repeat' => _x( 'No-repeat', 'Background Control', 'raven' ),
				'repeat' => _x( 'Repeat', 'Background Control', 'raven' ),
				'repeat-x' => _x( 'Repeat-x', 'Background Control', 'raven' ),
				'repeat-y' => _x( 'Repeat-y', 'Background Control', 'raven' ),
			],
			'selectors' => [
		...
		$fields['size'] = [
			'label' => _x( 'Size', 'Background Control', 'raven' ),
			'type' => 'select',
			'default' => '',
			'options' => [
				'' => _x( 'Default', 'Background Control', 'raven' ),
				'auto' => _x( 'Auto', 'Background Control', 'raven' ),
				'cover' => _x( 'Cover', 'Background Control', 'raven' ),
				'contain' => _x( 'Contain', 'Background Control', 'raven' ),
			],
			'selectors' => [
		...
		$fields['video_link'] = [
			'label' => _x( 'Video Link', 'Background Control', 'raven' ),
			'type' => 'text',
			'placeholder' => 'https://www.youtube.com/watch?v=9uOETcuFjbE',
			'description' => __( 'YouTube link or video file (mp4 is recommended).', 'raven' ),
			'label_block' => true,
			'default' => '',
			'condition' => [
				'background' => [ 'video' ],
		...
		$fields['video_fallback'] = [
			'label' => _x( 'Background Fallback', 'Background Control', 'raven' ),
			'description' => __( 'This cover image will replace the background video on mobile and tablet devices.', 'raven' ),
			'type' => 'media',
			'label_block' => true,
			'condition' => [
				'background' => [ 'video' ],
