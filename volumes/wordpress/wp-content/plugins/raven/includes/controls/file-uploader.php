	...
	public function content_template() {
			...
			<div class="elementor-control-input-wrapper">
				<div class="elementor-button-wrapper">
					<button class="elementor-button elementor-button-default elementor-repeater-add raven-control-file-uploader-button" type="button">
						...
						<i class="fa fa-upload" aria-hidden="true"></i> <?php echo __( 'Upload File', 'raven' ); ?>
					</button>
		...
		<div class="raven-control-file-uploader-warning">
			<div class="elementor-panel-alert elementor-panel-alert-danger">
				<ul>
					<li class="raven-control-file-uploader-warning-size"> <?php esc_html_e( 'Maximum allowed file size is', 'raven' ); ?> <strong><?php echo round( wp_max_upload_size() / ( 1024 * 1024 ), 2 ); ?> MB</strong></li>
				</ul>
			</div>
		</div>
		<?php
