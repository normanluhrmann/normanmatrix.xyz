	...
	public function register_general_settings() {
		...
		$this->add_control(
			...
			array(
				...
				'description' => __( 'Set meta field key to get address from. To get address from multiple meta fields, combine these fields names with "+" sign. For example: state+city+street', 'jet-engine' ),
