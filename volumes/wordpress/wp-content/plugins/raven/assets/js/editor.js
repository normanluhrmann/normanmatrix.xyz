...
var Query = elementor.modules.controls.Select2.extend({
  ...
  getValueTitles: function getValueTitles() {
    ...
    if ((!_.isArray(ids) || ids.length === 0) && multiple) {
      return;
    }
    ...
    window.elementorCommon.ajax.loadObjects({
      ...
      success: function success(ajaxData) {
        ...
        if (ajaxData && ajaxData.results && _.isArray(ajaxData.results)) {
          ajaxData.results.forEach(function (item) {
